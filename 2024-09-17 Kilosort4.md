...
<br/><br/>##<br/><br/># Pipeline steps

<br/><br/>###<br/><br/># Raw data format
...
```python
<br/><br/># SAVE_PATH.parent - file directory containg the binary file
...
```python
<br/><br/># outputs saved to results_dir
...
ops, st, clu, tF, Wall, similar_templates, is_ref, est_contam_rate, kept_spikes = \
    run_kilosort(
        ...
        <br/><br/># save_preprocessed_copy=True
        )
```
...
<br/><br/>##<br/><br/># Pre-processing in kilosort
...
<br/><br/>##<br/><br/># Output files of `run_kilosort`
...
<br/><br/>###<br/><br/># spike_templates 




<br/><br/>###<br/><br/># Understanding : `chan_best` for raster plot 
...
<br/><br/>###<br/><br/># Firing rate activity
...
<br/><br/>###<br/><br/># Contamination percentage: MUA vs Good units 
...
<br/><br/>###<br/><br/># Principal components 
