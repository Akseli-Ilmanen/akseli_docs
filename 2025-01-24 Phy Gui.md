...
<br/><br/>###<br/><br/># Best channel(s!) & Templates
...
<br/><br/># st -> template_ids for all spikes in this cluster_id
spike_ids = self.supervisor.clustering.spikes_per_cluster[cluster_id] 
st = self.model.spike_templates[spike_ids] 
<br/><br/># Find the template id that appears most frequently (highest count)
...
        if not template:  <br/><br/># pragma: no cover
            return [0]
